...
class Day6Test {
    ...
    void validForeigner_TargetedByVaccinationByNation() {
        inspector.receiveBulletin(
            """
                Allow citizens of Antegria
                Deny citizens of Kolechia
                Citizens of United Federation, Antegria require polio vaccination
                """);
    ...
    @Test
    void invalidForeigner_TargetedByVaccinationByNation_VaccinationAbsentOfCertificate() {
        inspector.receiveBulletin(
            """
                Allow citizens of Antegria
                Deny citizens of Kolechia
    ...
    @Test
    void validForeigner_TargetedByVaccinationForForeigners() {
        inspector.receiveBulletin(
            """
                Allow citizens of Antegria
                Deny citizens of Kolechia
